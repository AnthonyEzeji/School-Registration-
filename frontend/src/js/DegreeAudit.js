...
useEffect(() => {
  if(JSON.parse(window.sessionStorage.getItem("session")).user.UserType=="Student"){
    axios.get(`3.87.187.44:5001/api/enrollment/${JSON.parse(window.sessionStorage.getItem("session")).user.UserID}`).then(res=>{

      setStudentEnrollments(res.data)
    })
  }else{
    axios.get(`3.87.187.44:5001/api/enrollment/${JSON.parse(window.sessionStorage.getItem("current-student")).UserID}`).then(res=>{
...
useEffect(async () => {if(JSON.parse(window.sessionStorage.getItem("session")).user.UserType=="Student"){
  await axios.get(`3.87.187.44:5001/api/majorrequirements/${JSON.parse(window.sessionStorage.getItem("session")).user.UserID}`).then(res=>{
    console.log(res.data)
    setStudentMajorReq(res.data)
  })
}else{
 await axios.get(`3.87.187.44:5001/api/majorrequirements/${JSON.parse(window.sessionStorage.getItem("current-student")).UserID}`).then(res=>{
    console.log(res.data)
    setStudentMajorReq(res.data)
  })
}
  ...
  useEffect(async () => {
    if(JSON.parse(window.sessionStorage.getItem("session")).user.UserType=="Student"){
      await  axios.get(`3.87.187.44:5001/api/degree-audit/${JSON.parse(window.sessionStorage.getItem("session")).user.UserID}`).then(res=>{
        var sum = 0;
      ...
      await  axios.get(`3.87.187.44:5001/api/degree-audit/${JSON.parse(window.sessionStorage.getItem("current-student")).UserID}`).then(res=>{
        var sum = 0;
        for(var i = 0 ; i < studentHistory.length;i++){
          console.log(studentHistory[i].Course.Grade)
          if(studentHistory[i].Course.Grade == "A+"){
    ...
    useEffect(async() => {
 await axios.get(`3.87.187.44:5001/api/studentmajors/${JSON.parse(window.sessionStorage.getItem("session")).user.UserID}`).then(res=>{
